...
const ProfilePage = () => {
  ...
  // *the profile will have the default as elements of profileDataStructure
  let [profile, setProfile] = useState(profileDataStructure);

  // *Destructuring the elements from profile
  let {
  ...
  const getBlogs = ({ page = 1, user_id }) => {
    user_id = user_id == null ? blogs.user_id : user_id;
