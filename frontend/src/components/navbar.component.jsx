...
const Navbar = () => {
  ...
  //*Hadle UserNavPAnel [Hide & show onlick to profile]
  const handleUserNavPanel = () => {
    setUserNavPanel((currentVal) => !currentVal);
  };

  //*Handle Blur [touch anywhere will hide the userNavPanel]
  const handleBlur = () => {
    setTimeout(() => {
        ...
        <div className="flex items-center gap-3 md:gap-6 ml-auto">
          ...
          {access_token ? (
            <Link
              ...
              className="hidden md:flex sidebar-link"
            >
          ...
          {/* After a succesful Login, will render logout and profile */}
          {access_token ? (
            <>
